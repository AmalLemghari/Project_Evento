    ...
    <div class="flex items-center justify-center min-h-screen">
        ...
        <div class="relative p-4 w-full max-w-md max-h-full">
            ...
            <div class="relative bg-white rounded-lg shadow bg-blue-50">
                ...
                <form class="p-4 md:p-5" action="{{ route('updateCategories.edit', $category->id) }}" method="post">
                    @csrf                    
                        <div class="grid gap-4 mb-4 grid-cols-2">
                            ...
                            <div class="col-span-2">
                                ...
                                <input type="text" name="name" id="" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 bg-gray-100 border-gray-500 placeholder-gray-400 text-black focus:ring-primary-500 focus:border-primary-500" placeholder="" required="" value="{{ $events->name }}">
                            </div>
                        </div>
