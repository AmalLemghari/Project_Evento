<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight text-center">
            {{ __('Welcome to EventO! We are delighted to welcome you as a valued member of our team, bringing your leadership and expertise to our organization. Together, lets drive success and innovation in every endeavor') }}
        </h2>
    </x-slot>
